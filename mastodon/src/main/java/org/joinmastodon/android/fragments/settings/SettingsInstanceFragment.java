...
public class SettingsInstanceFragment extends BaseSettingsFragment<Void> implements HasAccountID{
	// Post formatting, emoji reactions, and local-only posting settings are hidden for this
	// build (occm.cc doesn't use them) - kept commented out instead of deleted in case they're
	// wanted back later, along with their wiring in onCreate/onHidden and their click handlers
	...
	// Unused while the settings above are hidden - kept for when they come back.
